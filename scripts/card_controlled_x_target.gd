@tool
class_name TargetX extends Card
# Called when the node enters the scene tree for the first time.

var CardTransformations: Array = []
...
func get_card_transformations():
	return CardTransformations
	
func set_card_transformations(card_array:Array):
	CardTransformations = card_array
