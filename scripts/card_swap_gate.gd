@tool
class_name SwapGate extends Card
# Called when the node enters the scene tree for the first time.
var SwapGateTarget: SwapGate
...
func set_output_value(output_value:String):
	OutputValue = output_value

func get_target():
	return SwapGateTarget

func set_target(target:SwapGate):
	SwapGateTarget = target
